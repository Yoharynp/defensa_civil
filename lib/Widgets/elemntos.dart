...
import 'package:flutter_svg/flutter_svg.dart';
  ...
  List<Widget> getElements(bool hastoken){
    if(hastoken){
      ...
      _buildElemento(4, SvgPicture.asset('assets/menu/exclamation.svg'), 'Medidas preventivas'),
      _buildElemento(5, SvgPicture.asset('assets/menu/users.svg'), 'Voluntariado'),
      _buildElemento(6, SvgPicture.asset('assets/menu/user.svg'), 'Acerca de'),
      _buildElemento(7, SvgPicture.asset('assets/map.svg'), 'Mapa de situaciones'),
      _buildElemento(8, SvgPicture.asset('assets/situaciones.svg'), 'Mis Situaciones'),
      _buildElemento(9, SvgPicture.asset('assets/reportar.svg'), 'Reportar situaiaciones'),
      _buildElemento(10, SvgPicture.asset('assets/contrasena.svg'), 'Cambiar Contraseña'),
      _buildElemento(11, SvgPicture.asset('assets/logout.svg'), 'Cerrar Sesión'),
      ];
  }else{
    return <Widget>[
      _buildElemento(0, SvgPicture.asset('assets/menu/home.svg'), 'Pagina Principal'),
      ...
      _buildElemento(5, SvgPicture.asset('assets/menu/users.svg'), 'Voluntariado'),
      _buildElemento(6, SvgPicture.asset('assets/menu/user.svg'), 'Acerca de'),
      _buildElemento(7, SvgPicture.asset('assets/menu/user-circle.svg'), 'Iniciar sesión'),
    ];
  }
  }
